...
public class ProductServiceTest {
	...
	public void testProductCreate(){
		Product p1 = productService.createProduct(new ProductInfo("EBC-abc-0001", 20.0, "TV", ProductCategory.A));
	...
	public void testProductUpdate(){
		Product p1 = productService.createProduct(new ProductInfo("FBC-abc-0001", 20.0, "TV", ProductCategory.A));
		Product p2 = productService.updateProduct(new ProductInfo("FBC-abc-0002", 30.0, "Tab", ProductCategory.B),p1.getId());
	...
	public void testProductUpdateForNonExistingProduct(){
		productService.createProduct(new ProductInfo("GBC-abc-0001", 20.0, "TV", ProductCategory.A));
		productService.updateProduct(new ProductInfo("GBC-abc-0002", 30.0, "Tab", ProductCategory.B),(long)99999);
	}
	
	
	@Test(expected=CustomException.class)
	public void testProductDelete(){
		Product p1 = productService.createProduct(new ProductInfo("HBC-abc-0001", 20.0, "TV", ProductCategory.A));
